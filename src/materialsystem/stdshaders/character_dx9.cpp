...
// like night vision and status effect detail textures into first-class
// parts of this shader, and also to make future features like a highlight
// for enemies part of the shader so it can immediately benefit every model
// replacement addon as well.
//
// The Character shader should always be paired with the Character material
